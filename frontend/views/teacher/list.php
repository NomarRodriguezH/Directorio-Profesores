    ...
    <div class="card mb-4">
        ...
        <div class="card-body">
            <form method="GET" action="lista-de-profesores" class="row g-3">
                ...
                <div class="col-md-2">
                    <label for="precio_min" class="form-label">Precio Máximo</label>
                ...
                <div class="col-md-2">
                    <label for="precio_max" class="form-label">Precio Minimo</label>
        ...
        <?php else: ?>
            <div class="col-12">
                <div class="alert alert-info text-center">
                    ...
                    <p>Intenta ajustar los filtros de búsqueda o <a href="teachers.php">ver todos los profesores</a></p>
                </div>
            </div>
        <?php endif; ?>
    </div>
